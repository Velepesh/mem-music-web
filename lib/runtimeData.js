const runtimeData = (function () {
    ...
    return {
        ...
        // File references.
        buildURL: "bin",
        loaderURL: "bin/Mem Music_Web_VKontakte.loader.js",
        dataURL: "bin/Mem Music_Web_VKontakte.data.unityweb",
        frameworkURL: "bin/Mem Music_Web_VKontakte.framework.js.unityweb",
        workerURL: "",
        codeURL: "bin/Mem Music_Web_VKontakte.wasm.unityweb",
        symbolsURL: "",
